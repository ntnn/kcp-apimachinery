...
func (s *sharedIndexInformer) ClusterContext(ctx context.Context, cluster logicalcluster.Name) cache.SharedIndexInformer {
	informer := newScopedSharedIndexInformer(s, cluster)
